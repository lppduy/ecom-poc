...
type InventoryServiceClient interface {
	...
	Confirm(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*CommonResponse, error)
	Release(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*CommonResponse, error)
}
...
func (c *inventoryServiceClient) Confirm(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *inventoryServiceClient) Release(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonResponse)
...
type InventoryServiceServer interface {
	...
	Confirm(context.Context, *OrderIDRequest) (*CommonResponse, error)
	Release(context.Context, *OrderIDRequest) (*CommonResponse, error)
...
func (UnimplementedInventoryServiceServer) Confirm(context.Context, *OrderIDRequest) (*CommonResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Confirm not implemented")
}
func (UnimplementedInventoryServiceServer) Release(context.Context, *OrderIDRequest) (*CommonResponse, error) {
...
func _InventoryService_Confirm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).Confirm(ctx, req.(*OrderIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InventoryService_Release_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).Release(ctx, req.(*OrderIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
